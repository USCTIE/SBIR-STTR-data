...
# output paths
csv_file_path = "output_sttr.csv"
xlsx_file_path = "output_sttr.xlsx"
...
def get_award_ids():
    ...
    award_ids = set()
    idv_ids = defaultdict(set)
    search_query = "/ezsearch/search.do?indexName=awardfull&templateName=1.5.3&s=FPDS.GOV&q=sttr+phase+iii"
